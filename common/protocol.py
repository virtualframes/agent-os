...
class JobRequest:
    ...
    payload: Dict[
        str, Any
    ]  # Job-specific data, e.g., {"code": "...", "language": "python"}
    user_id: str
...
class JobResult:
    ...
    payload: Dict[
        str, Any
    ]  # The result, e.g., {"code": "...", "explanation": "..."} or {"error": "..."}
...
class EventType(str, Enum):
    """Enumerates audit and coordination events on the message bus."""

    PFC_STARTED = "pfc.started"
    PFC_MERGE_CONFLICT = "pfc.merge_conflict"
    PFC_TEST_FAILED = "pfc.test_failed"
    PFC_CERTIFIED = "pfc.certified"
    AI_SYNTHESIS_REQUEST = "ai.synthesis.request"
    AI_SYNTHESIS_COMPLETED = "ai.synthesis.completed"


@dataclass
class Event:
    """Represents an immutable audit event propagated over NATS."""

    trace_id: str
    event_type: EventType
    timestamp: str  # ISO 8601 format
    source: str  # e.g. "pfc_agent_v3", "copilot_session_xyz"
